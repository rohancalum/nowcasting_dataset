...
class BatchImageDataArray(PydanticXArrayDataArray):
    ...
    @staticmethod
    def from_list_image_data_array(image_data_arrays: List[ImageDataArray]) -> BatchImageDataArray:
...
class BatchSatellite(ImageDataArray):
    """Superclass for image data (satellite imagery, NWPs, etc.)"""
...
class Example(BaseModel):
    ...
    satellite: Optional[Union[Satellite, BatchSatellite]]
...
satellite_batch = BatchImageDataArray.from_list_image_data_array([sat_1, sat_2])
